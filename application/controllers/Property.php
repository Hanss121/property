...
class Property extends CI_Controller {
    ...
    public function Rumah()
    {
        ...
        $this->load->view('nav/navbar');
        $this->load->view('Property_view_rumah', $data);
    ...
    public function Layout()
    {
        ...
        $this->load->view('nav/navbar');
        $this->load->view('Property_view_layout', $data);
    ...
    public function siteplane()
    {
        ...
        $this->load->view('nav/navbar');
        $this->load->view('Property_view_siteplane', $data);
    ...
    public function Rumah_dalam()
    {
        ...
        $this->load->view('nav/navbar');
        $this->load->view('Property_view_rumah_dalam', $data);
    ...
    public function delete_conten($no) {
        
        $this->content_model->delete($no);
        $this->session->set_flashdata('ubah', 'Menu berhasil diperbarui...!!!!.');
        // Lakukan redirect berdasarkan kondisi $Kategori
        if ($Kategori === 'RM1-RUMAH') {
            redirect('property/Rumah');
    ...
    public function delete_menu($no) {
        
        $this->menu_model->delete($no);
        redirect('Property');
        }
