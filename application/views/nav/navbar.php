            ...
            <div class="sm:flex ">
                <ul class="sm:flex  sm:rounded-none sm:shadow-none rounded-md shadow-md hidden  ml-2 mr-2 mb-2;"
                    ...
                    <li class="text-center sm:p-4 p-1 hover:bg-primary"><a class="hover:text-white"
                            href="<?php echo site_url('Property');?>">BERANDA</a>
                    </li>
                    <li class="text-center sm:p-4 p-1 hover:bg-primary"><a class="hover:text-white"
                            href="<?php echo site_url('property/profile');?>">PROFILE</a>
                    </li>
                    ...
                    <div
                        class="text-center sm:p-4 p-1 rounded-md sm:hover:bg-yellow-400 hover:text-white hover:bg-primary">
                        <div class="dropdown">
