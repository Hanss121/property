<div class="bg-slate-300 mt-5 ml-5 mr-5 rounded-md p-3">
    ...
    <?php echo form_open_multipart('Property/save_siteplane'); ?>
    <div class="sm:flex mt-5 ">
        <div class="">
            <label>Judul</label>
            <input class="py-1 mt-1 w-full px-3 rounded-md" readonly type="text" name="Nama" value="Siteplane">
        </div>
        <div class="mt-5 w-full">
            <label>Kategori</label>
            <input class="py-1 mt-1 w-full px-3 rounded-md" readonly type="text" name="Kategori" value="RM4-SITEPLANE">
        </div>
    </div>
    <div class="mt-5">
        <label>Gambar</label>
