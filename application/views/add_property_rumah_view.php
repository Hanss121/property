<div class="bg-slate-300 mt-5 ml-5 mr-5 rounded-md p-3">
    ...
    <?php echo form_open_multipart('Property/save'); ?>
    <div class="sm:flex mt-5 ">
        <div class="">
            <label>Judul</label>
            <input class="py-1 mt-1 w-full px-3 rounded-md" readonly type="text" name="Nama" value="Rumah">
        </div>
        <div class="mt-5 w-full">
            <label>Kategori</label>
            <div class="mt-5 w-full">
                <label>Kategori</label>
                <input class="py-1 mt-1 w-full px-3 rounded-md" type="text" name="Kategori" value="RM1-RUMAH">
            </div>
        </div>
    </div>
    <div class="mt-5">
