<div class="bg-slate-300 mt-5 ml-5 mr-5 rounded-md p-3">
    ...
    <?php echo form_open_multipart('Property/save_layout'); ?>
    <div class="sm:flex mt-5 ">
        <div class="">
            <label>Judul</label>
            <input class="py-1 mt-1 w-full px-3 rounded-md" type="text" name="Nama" value="Layout">
        </div>
        <div class="mt-5 w-full">
            <label>Kategori</label>
            <input class="py-1 mt-1 w-full px-3 rounded-md" readonly type="text" name="Kategori" value="RM2-LAYOUT">
        </div>
    </div>
    <div class="mt-5">
        <label>Gambar</label>
